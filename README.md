...
Если вы решите разместить сделанное задание на github, то убедитесь что в репозитории присутствует все необходимое для сборки приложения для production, это могут быть скрипты "build" / "start" в package.json или инструкция в файле README
